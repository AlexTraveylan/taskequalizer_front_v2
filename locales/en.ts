export default {
  ...
  "login-card.usernameField": "Username (or email)",
  ...
  "taskequalizer.ranking": "Total balance",
  ...
  "reset-password.description":
    "I do not have your password, it is completely encrypted, please enter a new one and remember it (ideally in a password manager)",
  "reset-password.passwordField": "New password",
  "reset-password.buttonLabel": "Change password",
  "reset-password.error-message": "Unable to change the password",
  ...
  "daily-chart.title": "Daily charts",
  "weekly-chart.title": "Graphics over a chosen period",
  "weekly-chart.period-choices": "Period selection",
  "weekly-chart.from": "From",
  "weekly-chart.to": "to",
  "weekly-chart.graph": "The graphs",
  "daily-chart.date-choice": "Select a day",
  "daily-chart.chosenDay": "Chosen day",
  "weekly-chart.nb-tasks.title": "Number of tasks over the period",
  "weekly-chart.nb-tasks.totalLabel": "Number of tasks",
  "weekly-chart.duration-tasks.title": "Task duration over the period",
  ...
  "successful-payment.title": "Successful payment",
