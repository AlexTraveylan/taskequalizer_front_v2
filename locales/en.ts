export default {
  ...
  "ephemeral-task-card-form.success-message": "The ephemeral task was completed successfully",
  "ephemeral-task-card-form.error-message": "An error occurred while completing the ephemeral task",
