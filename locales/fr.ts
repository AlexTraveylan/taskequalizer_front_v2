export default {
  ...
  "below-the-fold.how-it-works.description2":
    "Chaque membre du couple peut facilement enregistrer les tâches accomplies via mon interface intuitive.",
  "below-the-fold.how-it-works.description3":
    "Mon algorithme intelligent convertit ces données en statistiques claires et objectives, permettant une prise de conscience sans confrontation.",
  ...
  "faq.answer5":
    "Je prend la protection de vos données très au sérieux. Toutes les informations sont cryptées et stockées de manière sécurisée. Je ne partagerais jamais vos données personnelles avec des tiers. Pour plus de détails, consultez ma politique de confidentialité.",
  ...
  "faq.contactLinkMessage": "Contactez-moi",
  ...
  "contact.othersWay": "Autres moyens de me contacter",
  ...
  "privacy-policy.collected.part": "Je collecte les informations suivantes :",
  ...
  "privacy-policy.how-used.title": "Comment j'utilise vos informations",
  "privacy-policy.how-used.part": "J'utilise vos informations pour :",
  "privacy-policy.how-used.part1": "Fournir mes services",
  "privacy-policy.how-used.part2": "Personnaliser votre expérience utilisateur",
  "privacy-policy.how-used.part3": "Communiquer avec vous concernant votre compte ou mes services",
  "privacy-policy.shared.title": "Partage des informations",
  "privacy-policy.shared.part1": "Je ne vend ni ne loue vos informations personnelles à des tiers.",
  "privacy-policy.shared.part2": "Je peux partager vos informations dans les situations suivantes :",
  ...
  "privacy-policy.shared.part6": "Avec mes fournisseurs de services qui m'aide à exploiter mon application (Stripe en cas d'abonnement)",
  "privacy-policy.security.title": "Sécurité des données",
  "privacy-policy.security.part":
    "Je mets en œuvre des mesures de sécurité appropriées pour protéger vos informations contre l'accès non autorisé, l'altération, la divulgation ou la destruction.",
  ...
  "privacy-policy.modify.part1": "Je peux mettre à jour cette politique de confidentialité de temps à autre.",
  "privacy-policy.modify.part2": "Je vous informerai de tout changement important par e-mail ou par une notification dans l'application.",
  "privacy-policy.contact.title": "Me contacter",
  "privacy-policy.contact.part":
    "Si vous avez des questions concernant cette politique de confidentialité, veuillez me contacter à timothee.demares@alextraveylan.fr ou en utilisant le formulaire de contact.",
  ...
  "terms-of-use.accept.part2": "Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser mon service.",
  ...
  "terms-of-use.description.part2": "Mon service permet de suivre, analyser et visualiser la répartition des tâches au sein du foyer.",
  "terms-of-use.responsability.title": "Inscription et sécurité du compte",
  "terms-of-use.responsability.part1": "Pour utiliser mon service, vous devez créer un compte.",
  ...
  "terms-of-use.limit.part":
    "Timothée Demares ne sera pas responsable des dommages directs, indirects, accessoires, spéciaux ou consécutifs résultant de l'utilisation ou de l'impossibilité d'utiliser mon service.",
  "terms-of-use.modif.title": "Modifications des conditions",
  "terms-of-use.modif.part":
    "Je me réserve le droit de modifier ces conditions d'utilisation à tout moment. Les modifications entreront en vigueur dès leur publication sur cette page.",
  "terms-of-use.contact.title": "Contact",
  "terms-of-use.contact.part":
    "Si vous avez des questions concernant ces conditions d'utilisation, veuillez me contacter à timothee.demares@alextraveylan.fr ou sur le formulaire de contact mis à disposition.",
