export default {
  ...
  "ephemeral-task-card-form.success-message": "La tâche éphémère a été complétée avec succès",
  "ephemeral-task-card-form.error-message": "Une erreur s'est produite lors de la complétion de la tâche éphémère",
