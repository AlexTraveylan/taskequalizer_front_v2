export default {
  ...
  "ephemeral-task-card-form.success-message": "Die temporäre Aufgabe wurde erfolgreich erstellt",
  "ephemeral-task-card-form.error-message": "Ein Fehler ist aufgetreten bei der Erstellung der temporären Aufgabe",
