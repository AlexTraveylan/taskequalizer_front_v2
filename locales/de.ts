export default {
  ...
  "privacy-policy.security.part": "Wir setzen angemessene Sicherheitsmaßnahmen um, um Ihre Informationen vor unbefugtem Zugriff, Veränderung, Offenlegung oder Zerstörung zu schützen.",
  ...
  "privacy-policy.rights.part2": "Sie können auch der Verarbeitung Ihrer Daten widersprechen oder die Einschränkung dieser Verarbeitung verlangen.",
  ...
  "privacy-policy.contact.part": "Wenn Sie Fragen zu dieser Datenschutzrichtlinie haben, kontaktieren Sie uns bitte unter timothee.demares@alextraveylan.fr oder über das Kontaktformular.",
