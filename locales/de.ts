export default {
  ...
  "taskequalizer.ranking": "Gesamtbilanz",
  ...
  "weekly-chart.title": "Grafiken über einen gewählten Zeitraum.",
  "weekly-chart.period-choices": "Periodenauswahl",
  "weekly-chart.from": "Von",
  "weekly-chart.to": "to",
  "weekly-chart.graph": "Die Diagramme",
  "daily-chart.date-choice": "Wähle einen Tag",
  "daily-chart.chosenDay": "Ausgewählter Tag",
  "weekly-chart.nb-tasks.title": "Anzahl der Aufgaben über den Zeitraum",
  "weekly-chart.nb-tasks.totalLabel": "Anzahl der Aufgaben",
  "weekly-chart.duration-tasks.title": "Aufgaben Dauer über den Zeitraum",
  "weekly-chart.duration-tasks.totalLabel": "Gesamtsumme (in Minuten)",
  "weekly-chart.bar-nb-tasks.title": "Details zur Anzahl der abgeschlossenen Aufgaben pro möglicher Aufgabe im Laufe der Zeit.",
  ...
  "successful-payment.title": "Erfolgreiche Zahlung",
  "uccessful-payment.description": "Ihre Transaktion wurde erfolgreich verarbeitet.",
  "successful-payment.content": "Vielen Dank für Ihre Unterstützung, Sie können die neuen Funktionen sofort verwenden.",
  "uccessful-payment.footer": "Zurück zu den Einstellungen",
  "failed-payment.title": "Zahlung fehlgeschlagen",
